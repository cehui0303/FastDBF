...
namespace TestDbfLib
{
	internal class Program
	{
		...
		private static void TestWriteNewDbf()
		{
			...
			orec[0] = "St閒ani?Singer longer than fits in the DBF record!";
			orec[1] = "0.1";
			orec[2] = ".12";
			orec[3] = ".1";
			orec[4] = "";
		...
		private static void TestReadFile()
		{
            ...
            odbf.Open(Path.Combine("I:\\ccl\\data\\111", "云南省昭通市岔河水库工程建设项目.dbf"), FileMode.Open); //State_vars1.dbf  county_vars1.dbf
	  ...
	  */
		...
		/// <summary>
		/// 将936的dbf转为utf-8格式，支持android读取
		/// </summary>
		private static void TestConvertDbf()
		{
            var odbf = new DbfFile(Encoding.GetEncoding(936));

            odbf.Open(Path.Combine("I:\\ccl\\data\\111", "云南省昭通市岔河水库工程建设项目0.dbf"), FileMode.Open);

            var odbf2 = new DbfFile(Encoding.UTF8);
            odbf2.Open(Path.Combine("I:\\ccl\\data\\111", "云南省昭通市岔河水库工程建设项目.dbf"), FileMode.Create);
